    ...
    <section className="container">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-x-3">
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">Lista de stock</h2>
            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">
              2 productos
            </span>
            <span className="px-3 py-1 text-xs text-red-600 bg-red-200 rounded-full dark:bg-gray-800 dark:text-red-500">
      ...
      <div className="mt-6 md:flex md:items-center md:justify-between">
        <div className="relative flex items-center mt-4 md:mt-0">
          ...
          <input type="text" placeholder="Buscar por nombre de producto" className="block w-full py-1.5 pr-5 text-gray-700 bg-white border border-gray-200 rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>
      </div>
...
function TableRow() {
  return (
    <tr>
      <td className="px-8 py-4 text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap">
        Fibra monomodo
      </td>
