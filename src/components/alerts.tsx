...
function Success({...props}) {
  return (
    <div className="flex w-full max-w-sm overflow-hidden bg-emerald-500">
      ...
      <div className="px-4 py-2 -mx-3">
        <div className="mx-3">
          <span className="font-semibold text-slate-200">{props.title}</span>
          <p className="text-sm text-slate-200">{props.description}</p>
        </div>
      </div>
    </div>
  )
