  ...
  return (
    <div className="flex w-full max-w-sm overflow-hidden">
      ...
      <div className="px-4 py-2 -mx-3">
        <div className="mx-3">
          <span className="font-semibold text-emerald-500 dark:text-emerald-400">{props.title}</span>
          <p className="text-sm text-gray-600 dark:text-gray-200">{props.description}</p>
        </div>
      </div>
    </div>
  )
...
function Warning({...props}) {
  return (
    <div className="flex w-full max-w-sm overflow-hidden">
      ...
      <div className="px-4 py-2 -mx-3">
          <div className="mx-3">
              <span className="font-semibold text-yellow-400 dark:text-yellow-300">{props.title}</span>
